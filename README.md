...
This Power BI project aims to find the main reasons behind customer churn. By analyzing customer information such as demographics, contract types, and churn reasons, the dashboard helps turn large amounts of data into simple and easy-to-understand insights.
...
* **Identify high-risk customer groups:** Find out which customers are more likely to leave, such as users with Month-to-Month contracts.
...
## Churn Demographics
![Churn Demographics Dashboard](images/Churn_Demographics.png)
...
![Groups and Categories Dashboard](images/Groups_and_Categories.png)
...
## Unlimited Plan
![Unlimited Plan Dashboard](images/Unlimited_Plan.png)
...
## International Calls
![International Calls Dashboard](images/International_Calls.png)
...
## Contract Type
![Contract_Type_Dashboard](images/Contract_Type.png)
...
## Age groups
![Age_Groups_Dashboard](images/Age_Groups.png)
...
![Payment_and_Contract_Dashboard](images/Payment_and_Contract.png)
...
## Extra Charges
![Extra_Charges_Dashboard](images/Extra_Charges.png)
